...
function showForm($action, $origin, $destination, $ID){
   ...
   if($connection->errno > 0){
    ...
    echo "<center>";
    echo "<table border='0'>";
    echo "<tr><td align='right'>First Name:</td><td><input type='text' id='peepFName' name='peepFName' size='15' value='" . htmlspecialchars($FName,ENT_QUOTES) . "'/></td></tr>";
    echo "<tr><td align='right'>Last Name:</td><td><input type='text' id='peepLName' name='peepLName' size='15' value='" . htmlspecialchars($LName,ENT_QUOTES) . "'/></td></tr>";     
    echo "<tr><td align='right'>Address:</td><td><input type='text' id='peepAddress' name='peepAddress' size='25' value='" . htmlspecialchars($Address,ENT_QUOTES) . "'/></td></tr>";     
    echo "<tr><td align='right'>City:</td><td><input type='text' id='peepCity' name='peepCity' size='15' value='" . htmlspecialchars($City,ENT_QUOTES) . "'/> ";
    echo "<tr><td align='right'>State:</td><td><input type='text' id='peepState' name='peepState' size='2' value='" . htmlspecialchars($State,ENT_QUOTES) . "'/>";     
    echo "<tr><td align='right'>Zipcode:</td><td><input type='text' id='peepZipcode' name='peepZipcode' size='25' value='" . htmlspecialchars($Zipcode,ENT_QUOTES) . "'/></td></tr>";       
    echo "<tr><td align='right'>Phone 1:</td><td><input type='text' id='peepPhone1' name='peepPhone1' size='15' value='"  . htmlspecialchars($Phone1,ENT_QUOTES) . "'/></td></tr>";
    echo "<tr><td align='right'>Phone 2:</td><td><input type='text' id='peepPhone2' name='peepPhone2' size='15' value='"  . htmlspecialchars($Phone2,ENT_QUOTES) . "'/></td></tr>";
    echo "<tr><td align='right'>Email 1:</td><td><input type='text' id=peepEmail1' name='peepEmail1' size='40' value='"  . htmlspecialchars($Email1,ENT_QUOTES) . "'/></td></tr>";
    echo "<tr><td align='right'>Email 2:</td><td><input type='text' id='peepEmail2' name='peepEmail2' size='40' value='"  . htmlspecialchars($Email2,ENT_QUOTES) . "'/></td></tr>";
    
    echo "<tr><td align='right'>Spiritual Gifts:</td><td><textarea id='peepSpiritualGifts' name='peepSpiritualGifts' cols='40' rows='2'>" . htmlspecialchars($SpiritualGifts,ENT_QUOTES) . "</textarea></td></tr>";
    echo "<tr><td align='right'>Recovery Area:</td><td><textarea id='peepRecoveryArea' name='peepRecoveryArea' cols='40' rows='2'>" . htmlspecialchars($RecoveryArea,ENT_QUOTES) . "</textarea></td></tr>";
    echo "<tr><td align='right'>Recovery Since:</td><td><input type='text' id='peepRecoverySince' name='peepRecoverySince' size='15' value='" . htmlspecialchars($RecoverySince,ENT_QUOTES) . "'/></td></tr>";
    echo "<tr><td align='right'>CR Since:&nbsp;</td><td><input type='text' id='peepCRSince' name='peepCRSince' size='15' value='" . htmlspecialchars($CRSince,ENT_QUOTES) . "'/></td></tr>";
    ...
    echo "<tr><td align='right'>Areas Served:</td><td><textarea id='peepAreasServed' name='peepAreasServed' cols='40' rows='4'>" . htmlspecialchars($AreasServed,ENT_QUOTES) . "</textarea></td></tr>";
    echo "<tr><td align='right'>Joy Areas:</td><td><textarea id='peepJoyAreas' name='peepJoyAreas' cols='40' rows='4'>" . htmlspecialchars($JoyAreas,ENT_QUOTES) . "</textarea></td></tr>";
    echo "<tr><td align='right'>Reasons To Serve:</td><td><textarea peepReasonsToServe' name='peepReasonsToServe' cols='40' rows='5'>" . htmlspecialchars($ReasonsToServe,ENT_QUOTES) . "</textarea></td></tr>";
    echo "</table>";
    ...
    if ($FellowshipTeam == "0"){
        echo "<tr><td align='right'>Fellowship Team (setup, snacks,...):&nbsp;</td><td><input type='checkbox' id='peepFellowshipTeam' name='peepFellowshipTeam'>&nbsp;</td></tr>";
    }else{
        echo "<tr><td align='right'>Fellowship Team (setup, snacks, etc.):&nbsp;</td><td><input type='checkbox' id='peepFellowshipTeam' name='peepFellowshipTeam' checked>&nbsp;</td></tr>";
    }
    if ($TeachingTeam == "0"){
        echo "<tr><td align='right'>Teaching Team:&nbsp;</td><td><input type='checkbox' id='peepTeachingTeam' id='peepTeachingTeam' name='peepTeachingTeam'>&nbsp;</td></tr>";
    }else{
        echo "<tr><td align='right'>Teaching Team:&nbsp;</td><td><input type='checkbox' id='peepTeachingTeam' id='peepTeachingTeam' name='peepTeachingTeam' checked></td></tr>";
    }
    if ($PrayerTeam == "0"){
        echo "<tr><td align='right'>Prayer Team: </td><td><input type='checkbox' id='peepPrayerTeam' name='peepPrayerTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Prayer Team: </td><td><input type='checkbox' id='peepPrayerTeam' name='peepPrayerTeam' checked></td></tr>";
    }
    if ($NewcomersTeam == "0"){
        echo "<tr><td align='right'>Newcomers Team: </td><td><input type='checkbox' id='peepNewcomersTeam' name='peepNewcomersTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Newcomers Team: </td><td><input type='checkbox' id='peepNewcomersTeam' name='peepNewcomersTeam' checked></td></tr>";
    }
    if ($GreetingTeam == "0"){
        echo "<tr><td align='right'>Greeting Team: </td><td><input type='checkbox' id='peepGreetingTeam' name='peepGreetingTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Greeting Team: </td><td><input type='checkbox' id='peepGreetingTeam' name='peepGreetingTeam' checked></td></tr>";
    }
    if ($SpecialEventsTeam == "0"){
        echo "<tr><td align='right'>Special Events Team: </td><td><input type='checkbox' id='peepSpecialEventsTeam' name='peepSpecialEventsTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Special Events Team: </td><td><input type='checkbox' id='peepSpecialEventsTeam' name='peepSpecialEventsTeam' checked></td></tr>";
    }
    if ($ResourceTeam == "0"){
        echo "<tr><td align='right'>Resource Team: </td><td><input type='checkbox' id='peepResourceTeam' name='peepResourceTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Resource Team: </td><td><input type='checkbox' id='peepResourceTeam' name='peepResourceTeam' checked></td></tr>";
    }
    if ($SmallGroupTeam == "0"){
        echo "<tr><td align='right'>Small Group Team: </td><td><input type='checkbox' id='peepSmallGroupTeam' name='peepSmallGroupTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Small Group Team: </td><td><input type='checkbox' id='peepSmallGroupTeam' name='peepSmallGroupTeam' checked></td></tr>";
    }
    if ($StepStudyTeam == "0"){
        echo "<tr><td align='right'>Step Study Team: </td><td><input type='checkbox' id='peepStepStudyTeam' name='peepStepStudyTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Step Study Team: </td><td><input type='checkbox' id='peepStepStudyTeam' name='peepStepStudyTeam' checked></td></tr>";
    } 
    if ($TransportationTeam == "0"){
        echo "<tr><td align='right'>Transportation Team: </td><td><input type='checkbox' id='peepTransportationTeam' name='peepTransportationTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Transportation Team: </td><td><input type='checkbox' id='peepTransportationTeam' name='peepTransportationTeam' checked></td></tr>";
    }
    if ($WorshipTeam == "0"){
        echo "<tr><td align='right'>Worship Team: </td><td><input type='checkbox' id='peepWorshipTeam' name='peepWorshipTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Worship Team: </td><td><input type='checkbox' id='peepWorshipTeam' name='peepWorshipTeam' checked></td></tr>";
    }
    if ($LandingTeam == "0"){
        echo "<tr><td align='right'>Landing Team: </td><td><input type='checkbox' id='peepLandingTeam' name='peepLandingTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Landing Team: </td><td><input type='checkbox' id='peepLandingTeam' name='peepLandingTeam' checked></td></tr>";
    }
    if ($CelebrationPlaceTeam == "0"){
        echo "<tr><td align='right'>Celebration Place Team: </td><td><input type='checkbox' id='peepCelebrationPlaceTeam' name='peepCelebrationPlaceTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Celebration Place Team: </td><td><input type='checkbox' id='peepCelebrationPlaceTeam' name='peepCelebrationPlaceTeam' checked></td></tr>";
    }
    if ($SolidRockTeam == "0"){
        echo "<tr><td align='right'>Crosstalk Cafe Team: </td><td><input type='checkbox' id='peepSolidRockTeam' name='peepSolidRockTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Crosstalk Cafe Team:</td><td><input type='checkbox' id='peepSolidRockTeam' name='peepSolidRockTeam' checked></td></tr>";
    }
    if ($MealTeam == "0"){
        echo "<tr><td align='right'>Meal Team:</td><td><input type='checkbox' id='peepMealTeam' name='peepMealTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Meal Team:</td><td><input type='checkbox' id='peepMealTeam' name='peepMealTeam' checked></td></tr>";
    }
    if ($Chips == "0"){
        echo "<tr><td align='right'>Chips:&nbsp;</td><td><input type='checkbox' id='peepChips' name='peepChips'></td></tr>";
    }else{
        echo "<tr><td align='right'>Chips:&nbsp;</td><td><input type='checkbox' id='peepChips' name='peepChips' checked></td></tr>";
    }
    if ($CRImen == "0"){
        echo "<tr><td align='right'>CRI: Men:</td><td><input type='checkbox' id='peepCRImen' name='peepCRImen'></td></tr>";
    }else{
        echo "<tr><td align='right'>CRI: Men:</td><td><input type='checkbox' id='peepCRImen' name='peepCRImen' checked></td></tr>";
    }
    if ($CRIwomen == "0"){
        echo "<tr><td align='right'>CRI: Women:</td><td><input type='checkbox' id='peepCRIwomen' name='peepCRIwomen'></td></tr>";
    }else{
        echo "<tr><td align='right'>CRI: Women:</td><td><input type='checkbox' id='peepCRIwomen' name='peepCRIwomen' checked></td></tr>";
    }
    ...
    echo "<tr><td align='right'>Notes:</td><td><textarea id='peepNotes' name='peepNotes' cols='40' rows='5'>" . htmlspecialchars($Notes,ENT_QUOTES) . "</textarea></td></tr>";
    if ($Active == "0"){
    ...
    //echo "<tr><td></td><td><input type='reset' value='Reset' size='10'/>&nbsp;&nbsp;<input type='submit' value='Ok' size='10'/>";
