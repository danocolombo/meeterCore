...
<html>
	<head>
        ...
        <![endif]-->
        <script type="text/javascript" src="js/meeter.js"></script>
...
function showPeopleList() {
   ...
   echo "<div style='text-align:right; padding-right: 20px;'><a href='people.php?Action=ShowAll' onSubmit='DoPeopleSubmit();'><img src='images/btnShowAll.gif'/></a></div>";
   echo "<table>";
   while(list($ID, $FName, $LName) = $result->fetch_row()){
           echo "<tr><td>";
           echo "<a href='people.php?Action=Edit&PID=" . $ID . "' onSubmit='DoPeopleSubmit();'><img src='images/btnEdit.gif'></img></a></td>";
...
function showAllPeople() {
   ...
   $result = $connection->query($query, MYSQLI_STORE_RESULT);
   echo "<div style='text-align:right; padding-right: 20px;'><a href='people.php?Action=NewPeep' onSubmit='DoPeopleSubmit();'>NEW ENTRY</a></div>";
   ...
   while(list($ID, $FName, $LName, $Active) = $result->fetch_row()){
           ...
           if ($Active == '0'){
               echo "<a href=peepAction.php?Action=Activate&ID=" . $ID . "' onSubmit='DoPeopleSubmit();'><img src='images/btnInActive.gif' height='20' valign='bottom'/></a>";
           }
...
//    echo "<form id='mtgForm' action='" . $dest . "'  onSubmit='DoPeopleSubmit();' method='post'>";
    //echo "<form id='frmPeople-Add' destination='" . $dest . "'  onSubmit='DoPeopleSubmit();'>";
    echo "<form id='frmPeople-Add'>";
    ...
    if ($FellowshipTeam == "0"){
        echo "<tr><td align='right'>Fellowship Team (setup, snacks,...):&nbsp;</td><td><input type='checkbox' name='peepFellowshipTeam' id='peepFellowshipTeam'>&nbsp;</td></tr>";
    }else{
        echo "<tr><td align='right'>Fellowship Team (setup, snacks, etc.):&nbsp;</td><td><input type='checkbox' name='peepFellowshipTeam' id='peepFellowshipTeam' checked>&nbsp;</td></tr>";
    }
    if ($TeachingTeam == "0"){
        echo "<tr><td align='right'>Teaching Team:&nbsp;</td><td><input type='checkbox' name='peepTeachingTeam' id='peepTeachingTeam'>&nbsp;</td></tr>";
    }else{
        echo "<tr><td align='right'>Teaching Team:&nbsp;</td><td><input type='checkbox' name='peepTeachingTeam'  id='peepTeachingTeam' checked></td></tr>";
    }
    if ($PrayerTeam == "0"){
        echo "<tr><td align='right'>Prayer Team: </td><td><input type='checkbox' name='peepPrayerTeam' id='peepPrayerTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Prayer Team: </td><td><input type='checkbox' name='peepPrayerTeam' id='peepPrayerTeam' checked></td></tr>";
    }
    if ($NewcomersTeam == "0"){
        echo "<tr><td align='right'>Newcomers Team: </td><td><input type='checkbox' name='peepNewcomersTeam' id='peepNewcomersTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Newcomers Team: </td><td><input type='checkbox' name='peepNewcomersTeam' id='peepNewcomersTeam'checked></td></tr>";
    }
    if ($GreetingTeam == "0"){
        echo "<tr><td align='right'>Greeting Team: </td><td><input type='checkbox' name='peepGreetingTeam' id='peepGreetingTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Greeting Team: </td><td><input type='checkbox' name='peepGreetingTeam' id='peepGreetingTeam' checked></td></tr>";
    }
    if ($SpecialEventsTeam == "0"){
        echo "<tr><td align='right'>Special Events Team: </td><td><input type='checkbox' name='peepSpecialEventsTeam' id='peepSpecialEventsTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Special Events Team: </td><td><input type='checkbox' name='peepSpecialEventsTeam' id='peepSpecialEventsTeam' checked></td></tr>";
    }
    if ($ResourceTeam == "0"){
        echo "<tr><td align='right'>Resource Team: </td><td><input type='checkbox' name='peepResourceTeam' id='peepResourceTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Resource Team: </td><td><input type='checkbox' name='peepResourceTeam' id='peepResourceTeam' checked></td></tr>";
    }
    if ($SmallGroupTeam == "0"){
        echo "<tr><td align='right'>Small Group Team: </td><td><input type='checkbox' name='peepSmallGroupTeam' id='peepSmallGroupTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Small Group Team: </td><td><input type='checkbox' name='peepSmallGroupTeam' id='peepSmallGroupTeam' checked></td></tr>";
    }
    if ($StepStudyTeam == "0"){
        echo "<tr><td align='right'>Step Study Team: </td><td><input type='checkbox' name='peepStepStudyTeam' id='peepStepStudyTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Step Study Team: </td><td><input type='checkbox' name='peepStepStudyTeam' id='peepStepStudyTeam' checked></td></tr>";
    } 
    if ($TransportationTeam == "0"){
        echo "<tr><td align='right'>Transportation Team: </td><td><input type='checkbox' name='peepTransportationTeam' id='peepTransportationTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Transportation Team: </td><td><input type='checkbox' name='peepTransportationTeam' id='peepTransportationTeam' checked></td></tr>";
    }
    if ($WorshipTeam == "0"){
        echo "<tr><td align='right'>Worship Team: </td><td><input type='checkbox' name='peepWorshipTeam' id='peepWorshipTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Worship Team: </td><td><input type='checkbox' name='peepWorshipTeam' id='peepWorshipTeam' checked></td></tr>";
    }
    if ($LandingTeam == "0"){
        echo "<tr><td align='right'>Landing Team: </td><td><input type='checkbox' name='peepLandingTeam' id='peepLandingTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Landing Team: </td><td><input type='checkbox' name='peepLandingTeam' id='peepLandingTeam' checked></td></tr>";
    }
    if ($CelebrationPlaceTeam == "0"){
        echo "<tr><td align='right'>Celebration Place Team: </td><td><input type='checkbox' name='peepCelebrationPlaceTeam' id='peepCelebrationPlaceTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Celebration Place Team: </td><td><input type='checkbox' name='peepCelebrationPlaceTeam' id='peepCelebrationPlaceTeam' checked></td></tr>";
    }
    if ($SolidRockTeam == "0"){
        echo "<tr><td align='right'>Crosstalk Cafe Team: </td><td><input type='checkbox' name='peepSolidRockTeam' id='peepSolidRockTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Crosstalk Cafe Team:</td><td><input type='checkbox' name='peepSolidRockTeam' id='peepSolidRockTeam' checked></td></tr>";
    }
    if ($MealTeam == "0"){
        echo "<tr><td align='right'>Meal Team:</td><td><input type='checkbox' name='peepMealTeam' id='peepMealTeam'></td></tr>";
    }else{
        echo "<tr><td align='right'>Meal Team:</td><td><input type='checkbox' name='peepMealTeam' id='peepMealTeam' checked></td></tr>";
    }
    if ($Chips == "0"){
        echo "<tr><td align='right'>Chips:&nbsp;</td><td><input type='checkbox' name='peepChips' id='peepChips'></td></tr>";
    }else{
        echo "<tr><td align='right'>Chips:&nbsp;</td><td><input type='checkbox' name='peepChips' id='peepChips' checked></td></tr>";
    }
    if ($CRImen == "0"){
        echo "<tr><td align='right'>CRI: Men:</td><td><input type='checkbox' name='peepCRImen' id='peepCRImen'></td></tr>";
    }else{
        echo "<tr><td align='right'>CRI: Men:</td><td><input type='checkbox' name='peepCRImen' id='peepCRImen' checked></td></tr>";
    }
    if ($CRIwomen == "0"){
        echo "<tr><td align='right'>CRI: Women:</td><td><input type='checkbox' name='peepCRIwomen' id='peepCRIwomen'></td></tr>";
    }else{
        echo "<tr><td align='right'>CRI: Women:</td><td><input type='checkbox' name='peepCRIwomen' id='peepCRIwomen' checked></td></tr>";
    }
...
//    echo "<tr><td></td><td><input type='submit' value='Ok' size='10'/></td></tr>";
    echo "<tr><td></td><td>";
    echo "<label for='btn-people'>Okay</label><br>";
    echo "<input type='submit' value='Okay' id='btn-people'>";
    echo "</td></tr>";
//    echo "<tr><td></td><td><input type='submit' value='Ok' size='10'/></td></tr>";
    echo "</table></center>";
